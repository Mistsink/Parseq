...
from strhub.data.custom_generator import TextLabelBatched
...
class PARSeq(CrossEntropySystem):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(charset_path, batch_size, lr, warmup_pct, weight_decay)
    ...
    def training_step(self, batch: Tuple[torch.Tensor, TextLabelBatched], batch_idx) -> STEP_OUTPUT:
        images, labels = batch
        tgt = self.tokenizer.encode(labels.text, self._device)
