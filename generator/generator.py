...
from generator.font_support import has_char

from .data_generator import FakeTextDataGenerator
from .string_generator import create_strings_from_dict
from .util import find_all_newlines, load_fonts, load_dict
...
class DataGenerator:
    ...
    def _load_dict(self, dict_dir: str) -> None:
        ...
        for dict_file in os.listdir(dict_dir):
            ...
            if lang not in self.lang_fonts:
                continue
            self.lang_dict[lang] = load_dict(os.path.join(dict_dir, dict_file))
    ...
    def generate(self, verbose: bool=False) -> Tuple[Image.Image, Image.Image, str]:
        ...
        for lang in langs:
            ...
            _texts = create_strings_from_dict(
                max_length,
                allow_variable=True,
                count=count,
                lang_dict=self.lang_dict[lang],
            )
            texts.append(_texts)
...
def main(n: int = 3):
    g = DataGenerator(
        lang_dir="/Users/mistsink/Desktop/projects/parseq/assets/font",
        dict_dir="/Users/mistsink/Desktop/projects/parseq/assets/dict",
        background_img_dir="/Users/mistsink/Desktop/projects/parseq/assets/background",
        max_length=128,
        max_sentence_len=10,
    )
    for _ in range(n):
